...
RUN dotnet build "src/$project/$project.csproj" -c Release -o /app/build /p:GenerateDocumentationFile=false /p:NoWarn=1591

FROM build AS publish
RUN dotnet publish "src/$project/$project.csproj" -c Release -o /app/publish /p:UseAppHost=false /p:GenerateDocumentationFile=false
